function cost(data: any[], w: number, b: number) {
...
function gradient(data: any[], w: number, b: number) {
    let dj_dw = 0.0;
    let dj_db = 0.0;
...
export function* train(data: any[], iterations: number, w: number = Math.random(), b: number = Math.random(), alpha = 0.000001) {
